    ...
    <form class=" w-full flex flex-col gap-8" method="POST" action="<?= BASE_URL ?>/login">
        ...
        <div class="flex flex-col gap-4">
            <div class="flex flex-col flex-1">
                ...
                <input  type="email" name="email" value="<?= getOld("email.old") ?>" class="outline-none border-1 border-orange-500 rounded px-2 py-1" placeholder="Digite seu e-mail">
        ...
        <button class="cursor-pointer bg-gray-800 transition-all rounded outline-none border-none py-2 px-8 text-white cursor-pointer hover:bg-orange-500">Acessar</button>
    </form>
