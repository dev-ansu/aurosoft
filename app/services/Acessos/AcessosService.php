...
class AcessosService extends Model{
    ...
    protected array $columns = ['id', 'nome', 'chave', 'grupo_id'];
    ...
    {   
        ...
        $sql = "SELECT {$columns}, ga.nome as nome_grupo FROM {$this->table} LEFT JOIN grupo_acessos ga ON ga.id = {$this->table}.grupo_id";
