...
class UsuariosService extends Model{
    ...
    protected array $columns = ['id', 'nome', 'email', 'senha', 'telefone', 'nivel', 'ativo', 'rua', 'bairro', 'numero', 'foto', 'created_at', 'updated_at'];
    ...
    public function patch($key, $data): ServiceResponse{
        $this->columns = ['id', 'nome', 'email', 'senha', 'telefone', 'nivel', 'rua', 'bairro', 'numero'];
        ...
        if(isset($data['senha']) && !empty(trim($data['senha']))){
            ...
            if(!empty($user->senha)){
                ...
                if(!$passwordVerify){
                    ...
                    $this->columns = ['id', 'nome', 'email', 'telefone', 'nivel', 'rua', 'bairro', 'numero'];
                }
